...
class SpearmanR(Metric):
    ...
    def __init__(self, output_transform=lambda x: x, device="cpu"):
        ...
        super(SpearmanR, self).__init__(output_transform=output_transform, device=device)
    ...
    def compute(self):
        ...
        r,p = spearmanr(np.array(self._samples_x), np.array(self._samples_y))
        return r
